...
let message1 = "Вписывай в поля ответы и жми кнопку <span>Показать сказку</span> и увидиш, что получиться";
let message2 = "Если ты хочеш подредоктировать скзочку нажми <span>Сделать замену</span></p>"
